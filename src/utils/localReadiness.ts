...
export function buildLocalReadiness({
  ...
  return {
    ...
    stages: [
      ...
      { key: 'brief', label: '故事设定', status: 'LOCKED', href: `/projects/${projectId}`, detail: lockedDetail },
      { key: 'story', label: '故事剧本', status: 'LOCKED', href: `/projects/${projectId}/story`, detail: lockedDetail },
